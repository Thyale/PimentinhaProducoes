            ...
            <div className="w-11/12 m-auto Mobile:w-full">
                ...
                <div className="flex flex-row items-center flex-wrap w-full justify-around mt-6 gap-3">
                    <div id="FotosAbc" className="w-full max-w-96">
                        <img className="shadow-lg" src="/public/PraiaAbcImg.png" alt="Imagem de sessão de fotos na praia" />
                    ...
                    <div id="FotosAbc" className="w-full max-w-96">
                        <img className="shadow-lg" src="/public/BecaAbcImg.png" alt="Imagem de sessão de fotos com beca" />
                    ...
                    <div id="FotosAbc" className="w-full max-w-96">
                        <img className="shadow-lg" src="/public/FormaturaAbcImg.jpg" alt="Imagem de sessão de fotos da festa de formatura" />
