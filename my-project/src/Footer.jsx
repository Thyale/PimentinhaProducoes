        ...
        <footer className="flex flex-row justify-around p-3 Mobile:flex-col Mobile:items-start gap-2 Mobile:gap-4">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a className="font-aboreto text-md hover:text-Vinho" target="_Blank" href="https://wa.me/5581999641294?text=Olá%20gostaria%20de%20mais%20informações">WhatsApp</a></li>
                </ul>
            </div>
        </footer>
    )
